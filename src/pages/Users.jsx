...
const ROLE_META = {
  admin:  { label: 'Admin',  cls: 'bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 border border-red-100 dark:border-red-900/50',       icon: Shield },
...
const MODULE_COLORS = {
  'Faturat':      'bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400',
  'Klientët':     'bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400',
  'Shpenzimet':   'bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400',
              ...
              <div className="flex items-start justify-between gap-2">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-1.5 flex-wrap">
                      ...
                      {isMe && <span className="bg-red-100 dark:bg-red-900/50 text-red-600 dark:text-red-400 text-[11px] font-bold px-2 py-0.5 rounded-full">Unë</span>}
                    </div>
                ...
                {currentUser?.role === 'admin' && (
                  <div className="flex items-center gap-1 flex-shrink-0">
                    ...
                    {!isMe && (
                      <button className="p-1.5 rounded-lg text-gray-400 dark:text-gray-500 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 transition-colors"
                  ...
                  <button
                    ...
                    className={`px-2.5 py-1 text-xs font-bold rounded-lg border transition-all flex items-center gap-1.5 active:scale-95 ${
                      isMe
                        ...
                        : isActive
                          ? 'bg-red-50 dark:bg-red-900/30 border-red-200 dark:border-red-900/50 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/50'
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200/90 dark:border-gray-700 shadow-sm overflow-hidden">
        <div className="flex flex-wrap items-center justify-between gap-3 px-5 py-4 border-b border-gray-100 dark:border-gray-700">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            {/* Searchbar */}
            <div className="flex items-center gap-2 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-xl px-3 py-1.5 focus-within:border-red-400 dark:focus-within:border-red-500 transition-all">
            ...
            {(logSearch || logUserFilter !== 'all') && (
              <button
                className="text-xs font-bold text-gray-400 dark:text-gray-500 hover:text-red-500 dark:hover:text-red-400 flex items-center gap-1 transition-colors"
