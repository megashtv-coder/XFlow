        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              className="p-1 rounded-lg text-gray-400 dark:text-gray-500 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 transition-colors"
              title="Fshi"
            >
              <Trash2 size={14} />
            </button>
      ...
      <div className="px-4 sm:px-6 py-5 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-red-50 dark:bg-red-900/30 text-red-500 flex items-center justify-center flex-shrink-0">
              <ListTodo size={20} />
            </div>
            <div>
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-1.5 px-4 py-2 rounded-xl bg-red-500 hover:bg-red-600 text-white font-bold text-xs shadow-sm transition-all active:scale-95"
            title="Detyrë e re"
          >
            <Plus size={14} />
          ...
          <button
            onClick={handleAddTask}
            className="sm:hidden w-11 h-11 bg-red-500 hover:bg-red-600 text-white font-bold rounded-full transition-all shadow-md flex items-center justify-center"
            title="Detyrë e re"
          >
            <Plus size={22} />
          </button>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-900/40 rounded-2xl p-3">
            <p className="text-[11px] font-bold text-red-700 dark:text-red-300 mb-0.5">Vonuara</p>
            <p className="text-2xl font-black font-mono text-red-700 dark:text-red-300 tracking-tight">{overdueTasks}</p>
          </div>
        </div>
      </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-sm text-gray-400 mb-6 dark:text-gray-500">
              {search ? 'Provo kërkim tjetër.' : filterType === 'completed' ? 'Nuk keni detyrë të përfunduar.' : filterType === 'overdue' ? 'Nuk keni detyrë vonuar. 🎉' : 'Krijo detyrën e parë tënde'}
            </p>
