...
const MESSAGE_TYPES = {
  ...
  telegram: { label: '✈️ Telegram', color: 'bg-blue-100 text-blue-700', icon: Send },
      ...
      {stats && (
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 mb-6">
          ...
          <div className="bg-blue-50 rounded-lg p-3 border border-blue-100">
            <p className="text-xs text-blue-600 font-semibold uppercase">Telegram</p>
            <p className="text-2xl font-bold text-blue-700">{stats.byType.telegram || 0}</p>
          </div>
