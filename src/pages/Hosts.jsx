  ...
  return (
    <div className={`bg-white dark:bg-gray-800 rounded-2xl border transition-all duration-200 p-4 flex flex-col gap-3 ${
      copied
        ...
        : 'border-gray-200/90 dark:border-gray-700 hover:shadow-md hover:border-red-200 dark:hover:border-red-900/50'
    }`}>
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-center gap-1.5 min-w-0 flex-wrap">
          <p className="text-lg font-black font-mono text-gray-900 dark:text-gray-100">{fmt(host.amount)}</p>
          <span className="text-[9px] font-bold px-1.5 py-0.5 rounded-md bg-sky-50 dark:bg-sky-900/30 text-sky-600 dark:text-sky-400 flex-shrink-0">
    ...
    <div className="space-y-4">
      ...
      {filtered.length === 0 ? (
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-12 text-center space-y-3">
          <div className="w-12 h-12 rounded-2xl bg-red-50 dark:bg-red-900/30 text-red-500 mx-auto flex items-center justify-center">
            <Server size={22} />
          </div>
