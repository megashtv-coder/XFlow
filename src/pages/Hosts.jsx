    ...
    >
      <div className="space-y-4">
        <FormGroup label="Link">
          <input
            className="w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-500 font-mono"
            placeholder="https://..."
            value={url}
        ...
        <FormGroup label="Kategoria">
          <select
            className="w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-lg text-sm bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-red-500"
            value={category}
    ...
    <div className={`group flex items-center gap-1 rounded-xl border px-3 py-2 transition-colors ${
      ...
      <button onClick={copyLink} className="min-w-0 flex-1 text-left" title="Kliko për të kopjuar">
        <div className="flex items-center gap-1.5 min-w-0">
          ...
          {host.isPopular && (
            <span className="text-[9px] font-bold px-1.5 py-0.5 rounded-md bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 flex-shrink-0">
              Popullore
            </span>
          )}
        </div>
      ...
      <div className="flex items-center gap-0.5 flex-shrink-0 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
        ...
        <a
          ...
          className="p-1 rounded-lg text-gray-400 dark:text-gray-500 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30"
          title="Hap linkun"
        >
          ...
          <div key={cat.id} className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col">
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/40">
              ...
              <button
                ...
                className="w-6 h-6 flex items-center justify-center rounded-lg bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/50 transition-colors"
