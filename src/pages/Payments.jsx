          ...
          <table className="w-full text-sm min-w-[560px]">
            <thead className="sticky top-0 z-10">
              <tr className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/60">
                ...
                <th className="table-th hidden lg:table-cell cursor-pointer select-none hover:text-gray-700 dark:hover:text-gray-200"
            ...
            <tbody>
              {paged.map(p => (
                <tr key={p.id} className="hover:bg-gray-50 dark:hover:bg-gray-900/40 transition-colors group">
                  ...
                  <td className="table-td text-right font-mono text-amber-600 dark:text-amber-400 text-xs hidden md:table-cell">
                    {p.fee > 0 ? `- ${fmt(p.fee)}` : <span className="text-gray-300 dark:text-gray-600">—</span>}
                  </td>
                  <td className="table-td text-right font-mono font-bold text-emerald-600 dark:text-emerald-400">{fmt(p.net)}</td>
