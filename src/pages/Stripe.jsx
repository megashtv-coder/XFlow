      ...
      <div className="flex items-center justify-between mb-1.5">
        ...
        <div className="flex items-center gap-0.5 opacity-60 group-hover:opacity-100 transition-opacity">
          ...
          <button
            ...
            className="p-1 rounded text-gray-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30"
            title="Fshi"
          >
            <Trash2 size={11} />
          </button>
      ...
      <div className="flex items-center gap-1 shrink-0">
        <button
          ...
          className={`py-1 px-2.5 rounded-lg font-bold text-[11px] flex items-center gap-1 transition-all ${
            copied ? 'bg-emerald-500 text-white' : 'bg-red-50 hover:bg-red-100 dark:bg-red-900/20 text-red-600 dark:text-red-400'
          }`}
        >
          {copied ? <><Check size={12} /> U kopjua!</> : <><Copy size={12} /> Kopjo</>}
        </button>
        ...
        <button onClick={ev => { ev.stopPropagation(); onDelete(link) }} className="p-1 text-gray-400 hover:text-red-600 dark:hover:text-red-400" title="Fshi">
          <Trash2 size={12} />
        </button>
      </div>
    </div>
...
══════════════════════════════════════════════════════════ */
const VIEW_KEY = 'xflow_stripe_view'
    ...
    <div className="space-y-3.5">
      ...
      <div className="bg-white dark:bg-gray-800 p-2.5 sm:p-3 rounded-2xl border border-gray-200/90 dark:border-gray-700 shadow-sm space-y-2.5">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2 pt-2 border-t border-gray-100 dark:border-gray-700/80">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              className="w-full pl-9 pr-8 py-1.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 text-gray-900 dark:text-white placeholder-gray-400 text-xs font-medium outline-none focus:ring-2 focus:ring-red-50 dark:focus:ring-red-900/20 focus:border-red-400 transition-all"
            ...
            {AMOUNT_FILTERS.map(f => (
              <button
                ...
                className={`px-2.5 py-1 rounded-lg whitespace-nowrap transition-all ${
                  amountFilter === f.id
                    ? 'bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 font-bold border border-red-200/80 dark:border-red-900/60'
      ...
      {filtered.length === 0 ? (
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-10 text-center space-y-3">
          <div className="w-11 h-11 rounded-xl bg-red-50 dark:bg-red-900/30 text-red-500 mx-auto flex items-center justify-center">
            <Link2 size={20} />
          </div>
