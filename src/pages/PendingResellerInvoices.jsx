  ...
  return (
    <div className="space-y-4 max-w-6xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Në pritje — Reseller</h1>
          <p className="text-sm text-gray-500 mt-1 dark:text-gray-400">Fatura të papaguara — Reseller</p>
        </div>
      </div>
