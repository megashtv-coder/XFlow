...
export default function AIChat() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 sm:p-6 space-y-5">
      {/* Banner */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-red-600 via-red-500 to-amber-500 p-6 text-white shadow-lg shadow-red-500/15">
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                <h1 className="text-xl sm:text-2xl font-black tracking-tight">AI Asistenti X-Flow</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-5">
        ...
        <div className="lg:col-span-1 space-y-4">
            ...
            <div className="space-y-2">
              {QUICK_PROMPTS.map((p, idx) => (
                <button
                  ...
                  className="w-full text-left p-2.5 rounded-xl border border-gray-100 dark:border-gray-700 bg-gray-50/70 dark:bg-gray-900/40 hover:bg-red-50 dark:hover:bg-red-900/20 hover:border-red-200 dark:hover:border-red-900/40 transition-all"
                >
          ...
          <div className="bg-gray-900 text-white rounded-2xl p-4 space-y-2">
            <div className="flex items-center justify-between border-b border-gray-800 pb-2 mb-1">
              ...
              <span className="text-[10px] bg-red-500/20 text-red-300 px-2 py-0.5 rounded-full font-bold">X-Flow</span>
            </div>
        ...
        <div className="lg:col-span-3 flex flex-col h-[620px] bg-white dark:bg-gray-800 rounded-2xl border border-gray-200/90 dark:border-gray-700 shadow-sm overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            {loading && (
              <div className="flex items-center gap-2.5">
                <div className="w-7 h-7 rounded-xl bg-red-500 text-white flex items-center justify-center shrink-0 text-[10px] font-bold">AI</div>
          ...
          >
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2.5 text-xs rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 text-gray-900 dark:text-white placeholder-gray-400 outline-none focus:ring-2 focus:ring-red-50 dark:focus:ring-red-900/20 focus:border-red-400"
                disabled={loading}
              />
              <button
                type="submit"
                disabled={loading || !input.trim()}
                className="px-4 py-2.5 rounded-xl bg-red-500 hover:bg-red-600 disabled:opacity-50 text-white font-bold text-xs flex items-center gap-1.5 transition-colors flex-shrink-0"
              >
                <span>Dërgo</span>
                <Send size={14} />
              </button>
    ...
    case 'user':
      return (
        <div className="flex gap-2.5 justify-end">
          <div className="max-w-[74%] px-3.5 py-2.5 rounded-2xl rounded-tr-sm text-xs bg-red-500 text-white font-medium">
            {message.content}
          </div>
    ...
    case 'system':
      return (
        <div className="flex gap-2.5">
          <div className="w-7 h-7 rounded-xl bg-red-500 text-white flex items-center justify-center shrink-0 mt-0.5 text-[10px] font-bold">AI</div>
