...
const MAPS = {
  ...
  expenses: {
    ...
    template: [
      ['Data','Kategoria','Lloji','Furnitori','Referenca','Paguar nga','Shuma'],
      ['2026-01-15','Software','Blerje Krediti Predator','Predator','500 kredit','Enndy','800'],
      ['2026-01-16','Internet','Abonimit Internet','Albtelecom','Pagesë mujore','Enndy','50'],
      ['2026-01-17','Zyre','Qira e zyrës','Pronari i zyrës','Qira janar','Samki','600'],
      ['2026-01-18','Hardware','Blerjë router','TP-Link','Router wifi','Samki','120'],
      ['2026-01-19','Marketing','Reklama Google','Google Ads','Google Ads campaign','Enndy','250'],
    ],
    build: (row, idx) => ({
