...
/* ══════════════════════════════════════════════════════════
   ...
   tjetër (ndryshe nga <select> e vjetër, ku "+ Shto lloj të ri"
   e vendoste vlerën vetëm në këtë shpenzim, jo në listë).
══════════════════════════════════════════════════════════ */
      ...
      {open && (
        <div className="absolute z-50 mt-1 w-full bg-white border border-gray-200 rounded-xl shadow-lg max-h-52 overflow-y-auto dark:bg-gray-800 dark:border-gray-700">
          ...
          {filtered.length === 0 && !query.trim() ? (
            <div className="px-3 py-3 text-xs text-gray-400 text-center dark:text-gray-500">Ende s'ka lloje — fillo duke shkruar</div>
          ) : null}
        </div>
      )}
    </div>
